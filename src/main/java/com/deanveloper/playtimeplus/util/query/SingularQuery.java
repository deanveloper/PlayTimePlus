 ...
 * @author Dean
 */
public class SingularQuery extends Query {
    private final String type;
    private final String valueAsString;
    private final LocalDateTime time;
    private final LocalDateTime endTime;

    public SingularQuery(String type, String valueAsString) {
        this.type = type;
        ...
        if (type.equals("after") || type.equals("before")) {
            ...
            if (timesAsStrings.length == 2) {
                ...
                throw new QueryParseException(type + " should be in the form \"time1...time2\"");
            }
        } else {
            throw new QueryParseException(type + " is not a valid query type!");
        }
    }
